...
let previousVolumeValue = volumeBar.value
const progressBar = document.getElementById('progress-bar')
const videoTimeLeft = document.querySelector('.video__time-left')
...
video.addEventListener('timeupdate', () => {
    ...
    videoTimeLeft.innerHTML = `${minutes}:${seconds.toString().padStart(2, "0")}`;
})
